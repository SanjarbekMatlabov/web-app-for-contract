...
const ContractWebApp = () => {
  const [formData, setFormData] = useState({
    ...
    tv_zona_mdf: '',
    tv_zona_decor: '',
    tv_zona_shkaf_count: '0',  // YANGI
    tv_zona_shkaf_size: '',    // YANGI
    tv_zona_shkaf_mdf: '',     // YANGI
    shkaf_count: '0',
    tumba_count: '0',
    tumba_size: '',
    tumba_mdf: '',
        ...
        <div className="bg-white rounded-lg shadow-xl p-12 print:shadow-none print:rounded-none" id="contract">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-1 text-sm">
              ...
              <p className="ml-4">2.1.3. Ушбу шарноманинг 3.1. бандига мувофиқ унинг жорий ҳисобварағига олдиндан тўловни 70% кабул килгандан кейин ушбу шартнома бўйича ишларни бажаришни бошлайди.</p>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-8 text-sm">
              ...
              <div>
                ...
                <p>Манзил: Qarshi sh. Mustaqillik I.Karimov</p>
                <p className="ml-14">Kucha 10M-Uy</p>
                <p>ИНН: 309 947 278</p>
